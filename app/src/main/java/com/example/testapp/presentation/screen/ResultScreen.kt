...
fun ResultScreen(
    ...
    // 当前考试/练习统计：有 history 就用 history，没有再用传入参数
    val currentScore      = latest?.score     ?: score
    val currentTotal      = latest?.total     ?: total
    val currentUnanswered = latest?.unanswered ?: unanswered
