package com.example.testapp.presentation.screen.question
...
fun QuestionScreen(
    ...
    // 判断是否为题目详情模式（question_detail 路由进入）
    // 若 quizId 包含 "favorite" 或从详情模式进入时，视为详情模式
    // 可根据实际业务需求调整判断条件
    val isDetailMode = true // 详情编辑模式
