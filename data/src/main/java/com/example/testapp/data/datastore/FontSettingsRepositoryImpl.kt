...
class FontSettingsRepositoryImpl @Inject constructor(
    ...
    private val EXAM_LETTER_SPACING_KEY = floatPreferencesKey("exam_letter_spacing")
    ...
    override val practiceLineSpacing: Flow<Float> = readFlow(PRACTICE_LINE_SPACING_KEY, 1.3f)
    override val practiceLetterSpacing: Flow<Float> = readFlow(PRACTICE_LETTER_SPACING_KEY, 0f)
    ...
    override val examLetterSpacing: Flow<Float> = readFlow(EXAM_LETTER_SPACING_KEY, 0f)
    ...
    override suspend fun setPracticeLineSpacing(value: Float) = write(PRACTICE_LINE_SPACING_KEY, value)
    override suspend fun setPracticeLetterSpacing(value: Float) = write(PRACTICE_LETTER_SPACING_KEY, value)
    ...
    override suspend fun setExamLetterSpacing(value: Float) = write(EXAM_LETTER_SPACING_KEY, value)
